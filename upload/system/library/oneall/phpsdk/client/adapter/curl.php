 ...
 * Class Curl
 *
 * @package Oneall\Phpsdk\Client\Adapter
 */
class Curl extends AbstractClient
{
	...
	private function request ($path)
	{
		...
		$response = new \Oneall\Phpsdk\Client\Response ($code, $header, $body, $version, $reason);
	...
	/**
	 * Inject option into the curl handler.
	 * Add prefix 'CURLOPT_' to option name if required
	 *
	...
	protected function initOptions ()
	{
		...
		// Default Options
        $this->setOption ('USERAGENT', 'Mozilla/5.0 (OneAll Curly) Gecko/20080311 SingleSignOn/2.0.0 Firefox/2.0.0.13');
